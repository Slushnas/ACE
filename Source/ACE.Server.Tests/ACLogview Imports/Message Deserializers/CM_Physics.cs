...
using System.IO;
using System.Text;
using ACE.Server.Tests.ACLogview_Imports;
using ACE.Server.Tests.ACLogview_Imports.Enums;
using ACE.Server.Tests.ACLogview_Imports.Message_Deserializers;

namespace ACE.Server.Tests.Message_Deserializers
{
    class CM_Physics
    {
        ...
        public class Subpalette
        {
            ...
            public static Subpalette read(BinaryReader binaryReader)
            {
                ...
                newObj.subID = Packets.readDataIDOfKnownType(0x4000000, binaryReader);
        ...
        public class TextureMapChange
        {
            ...
            public static TextureMapChange read(BinaryReader binaryReader)
            {
                ...
                newObj.old_tex_id = Packets.readDataIDOfKnownType(0x5000000, binaryReader);
                ...
                newObj.new_tex_id = Packets.readDataIDOfKnownType(0x5000000, binaryReader);
        ...
        public class AnimPartChange
        {
            ...
            public static AnimPartChange read(BinaryReader binaryReader)
            {
                ...
                var startPosition = binaryReader.BaseStream.Position;
                newObj.part_index = binaryReader.ReadByte();
                newObj.part_id = Packets.readDataIDOfKnownType(0x1000000, binaryReader);
                newObj.Length = (int)(binaryReader.BaseStream.Position - startPosition);
                return newObj;
            }
        }
        ...
        public class ObjDesc
        {
            ...
            public static ObjDesc read(BinaryReader binaryReader)
            {
                ...
                if (newObj.num_subpalettes > 0)
                {
                    ...
                    newObj.paletteID = Packets.readDataIDOfKnownType(0x4000000, binaryReader);
        ...
        { // Not actually a class in client, but is here for convenience
            public uint id;
        ...
        public class PublicWeenieDesc
        {
            ...
            public static PublicWeenieDesc read(BinaryReader binaryReader)
            {
                ...
                newObj._wcid = Packets.readWClassIDCompressed(binaryReader);
                newObj._wcid_length = (int)(binaryReader.BaseStream.Position - wcidStart);
                var iconIdStart = binaryReader.BaseStream.Position;
                newObj._iconID = Packets.readDataIDOfKnownType(0x6000000, binaryReader);
                ...
                if ((newObj.header & (uint)PublicWeenieDescPackHeader.PWD_Packed_IconOverlay) != 0)
                {
                    ...
                    newObj._iconOverlayID = Packets.readDataIDOfKnownType(0x6000000, binaryReader);
                ...
                if ((newObj.header2 & (uint)PublicWeenieDescPackHeader2.PWD2_Packed_IconUnderlay) != 0)
                {
                    ...
                    newObj._iconUnderlayID = Packets.readDataIDOfKnownType(0x6000000, binaryReader);
